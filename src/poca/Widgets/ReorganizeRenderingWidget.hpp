...
*
* File:        ReorganizeRenderingWidget.hpp
*
...
#ifndef ReorganizeRenderingWidget_h__
#define ReorganizeRenderingWidget_h__
...
//! [0]
class ReorganizeRenderingWidget : public QGroupBox, public poca::core::ObserverForMediator {
	Q_OBJECT

public:
	ReorganizeRenderingWidget(poca::core::MediatorWObjectFWidgetInterface*, QWidget* = 0);
	~ReorganizeRenderingWidget();
...
protected slots:
	...
	void updateCommands(QListWidgetItem*, QListWidgetItem*);
...
protected:
	...
	QListWidget* m_basicComponentsList, * m_commandsList;
