...
*
* File:      VoronoiDiagramBasicCommands.hpp
*
...
class VoronoiDiagramBasicCommands : public poca::core::Command
{
public:
	VoronoiDiagramBasicCommands(poca::geometry::VoronoiDiagram*);
	VoronoiDiagramBasicCommands(const VoronoiDiagramBasicCommands&);
	~VoronoiDiagramBasicCommands();
