...
#ifndef ObjectList_PLUGIN_H
#define ObjectList_PLUGIN_H
...
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "objectlistplugin.json")
