...
*
* File:      DelaunayTriangulationBasicCommands.hpp
*
...
#ifndef DelaunayTriangulationBasicCommands_h__
#define DelaunayTriangulationBasicCommands_h__

#include <General/Command.hpp>
#include <Interfaces/DelaunayTriangulationInterface.hpp>

class DelaunayTriangulationBasicCommands: public poca::core::Command
{
public:
	DelaunayTriangulationBasicCommands(poca::geometry::DelaunayTriangulationInterface*);
