...
*
* File:      DelaunayTriangulationPlugin.hpp
*
...
#ifndef DELAUNAY_TRIANGULATION_PLUGIN_H
#define DELAUNAY_TRIANGULATION_PLUGIN_H
...
class DelaunayTriangulationConstructionCommand : public poca::core::Command
{
public:
    DelaunayTriangulationConstructionCommand(poca::geometry::DetectionSet*);
    DelaunayTriangulationConstructionCommand(const DelaunayTriangulationConstructionCommand&);
    ~DelaunayTriangulationConstructionCommand();
...
//! [0]
class DelaunayTriangulationPlugin : public QObject, PluginInterface
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "delaunaytriangulationplugin.json")
...
public:
    ...
    QString name() const { return "DelaunayTriangulationPlugin"; }
    void execute(poca::core::CommandInfo*) {}
