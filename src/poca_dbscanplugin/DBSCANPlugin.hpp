...
#ifndef DBSCAN_PLUGIN_H
#define DBSCAN_PLUGIN_H
...
//! [0]
class DBSCANPlugin : public QObject, PluginInterface
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "dbscanplugin.json")
...
public:
    ...
    QString name() const { return "DBSCANPlugin"; }
