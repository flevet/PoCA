...
class ColocTesselerConstructionCommand : public poca::core::Command
{
public:
    ColocTesselerConstructionCommand(poca::core::MyObject*);
...
protected:
    poca::core::MyObject* m_object;
};

class ColocTesselerPlugin : public QObject, PluginInterface
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "coloctesselerplugin.json")
