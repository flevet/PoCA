...
*
* File:      ObjectColocalizationPlugin.hpp
*
...
class ObjectColocalizationConstructionCommand : public poca::core::Command
{
public:
    ObjectColocalizationConstructionCommand(poca::core::MyObjectInterface*);
    ObjectColocalizationConstructionCommand(const ObjectColocalizationConstructionCommand&);
    ~ObjectColocalizationConstructionCommand();
...
//! [0]
class ObjectColocalizationPlugin : public QObject, PluginInterface
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "objectcolocalizationplugin.json")
