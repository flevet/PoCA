...
#ifndef KRipley_PLUGIN_H
#define KRipley_PLUGIN_H
...
//! [0]
class KRipleyPlugin : public QObject, PluginInterface
{
    Q_OBJECT
        Q_PLUGIN_METADATA(IID "POCA.PluginInterface_iid" FILE "kripleyplugin.json")
...
public:
    ...
    QString name() const { return "KRipleyPlugin"; }
